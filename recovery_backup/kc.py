...
def app():
    ...
    st.write('Here you can find helpful information about diabetes, prevention and care.')
import streamlit as st
...
def app():
    ...
    with col1:
        ...
        st.image(str(images_dir / '1.png'), caption="Diabetes Detection", width=200)
    with col2:
        st.markdown('''
    ...
    with col1:
        ...
        ''')
    with col2:
        st.image(str(images_dir / '2.png'), caption="Medical Recommendations", width=200)

    # Paragraph 3: Capsule Chatbot
    col1, col2 = st.columns([1, 2])
    with col1:
        st.image(str(images_dir / '3.png'), caption="Capsule Chatbot", width=200)
    with col2:
        st.markdown('''
    ...
    with col1:
        ...
        ''')
    with col2:
        st.image(str(images_dir / '4.png'), caption="Trend Visualization", width=200)

    # Paragraph 5: Streamlit Integration
    col1, col2 = st.columns([1, 2])
    with col1:
        st.image(str(images_dir / '5.png'), caption="Streamlit Integration", width=200)
    with col2:
        st.markdown('''
